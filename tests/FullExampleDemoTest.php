 ...
 * @internal
 */
final class FullExampleDemoTest extends \PHPUnit\Framework\TestCase
{
    public function testBounceHandling()
    {
        ...
        // ----------------------------------------------------------
        static::assertSame('1: 0000 | unrecognized | none | <span style="color:gray;">not deleted</span> | Robert Hafner <tedium@gmail.com> | Are you looking for tedivm? Re: With CC<br />
